...
create_xcframework()
{
    xcodebuild -create-xcframework \
        -library $ICU_VER_NAME-macos-build/source/lib/lib$1.a \
        ...
        -library $ICU_VER_NAME-xros.sim-build/source/lib/lib$1.a \
        -library $ICU_VER_NAME-xros-arm64-build/source/lib/lib$1.a \
        -output $INSTALL_DIR/frameworks/$1.xcframework
}
