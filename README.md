...
Repository branches generally correspond to ICU maintenance branches. For example, the `70` branch corresponds to the `maint/maint-70` branch in the ICU repository.

### Supported ICU Version: 70.1
...
git clone -b 70.1.2 https://github.com/apotocki/icu4c-iosx
...
# Data file path: product/share/icu/70.1/icudt70l.dat
```
...
u_setDataDirectory("PATH_TO_DIRECTORY_CONTAINING_icudt70l.dat");
...
# pod 'icu4c-iosx', :git => 'https://github.com/apotocki/icu4c-iosx', :tag => '70.1.2'
```    
