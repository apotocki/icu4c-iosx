...
Repository branches generally correspond to ICU maintenance branches. For example, the `72` branch corresponds to the `maint/maint-72` branch in the ICU repository.

### Supported ICU Version: 72.1
...
git clone -b 72.1.2 https://github.com/apotocki/icu4c-iosx
...
# Data file path: product/share/icu/72.1/icudt72l.dat
```
...
u_setDataDirectory("PATH_TO_DIRECTORY_CONTAINING_icudt72l.dat");
...
# pod 'icu4c-iosx', :git => 'https://github.com/apotocki/icu4c-iosx', :tag => '72.1.2'
```    
