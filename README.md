...
git clone -b 73.1.1 https://github.com/apotocki/icu4c-iosx
...
# Data file path: product/share/icu/73.1/icudt73l.dat
```
...
# pod 'icu4c-iosx', :git => 'https://github.com/apotocki/icu4c-iosx', :tag => '73.1.1'
```    
