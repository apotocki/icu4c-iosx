...
Repository branches generally correspond to ICU maintenance branches. For example, the `74` branch corresponds to the `maint/maint-74` branch in the ICU repository.

### Supported ICU Version: 74.1
...
git clone -b 74.1.1 https://github.com/apotocki/icu4c-iosx
...
# Data file path: product/share/icu/74.1/icudt74l.dat
```
...
u_setDataDirectory("PATH_TO_DIRECTORY_CONTAINING_icudt74l.dat");
...
# pod 'icu4c-iosx', :git => 'https://github.com/apotocki/icu4c-iosx', :tag => '74.1.1'
```    
