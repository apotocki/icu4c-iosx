...
Repository branches generally correspond to ICU maintenance branches. For example, the `68` branch corresponds to the `maint/maint-68` branch in the ICU repository.

### Supported ICU Version: 68.2
...
git clone -b 68.2.2 https://github.com/apotocki/icu4c-iosx
...
# Data file path: product/share/icu/68.2/icudt68l.dat
```
...
u_setDataDirectory("PATH_TO_DIRECTORY_CONTAINING_icudt68l.dat");
...
# pod 'icu4c-iosx', :git => 'https://github.com/apotocki/icu4c-iosx', :tag => '68.2.2'
```    
