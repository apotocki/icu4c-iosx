...
Repository branches generally correspond to ICU maintenance branches. For example, the `75` branch corresponds to the `maint/maint-75` branch in the ICU repository.

### Supported ICU Version: 75.1
...
git clone -b 75.1.4 https://github.com/apotocki/icu4c-iosx
...
# Data file path: product/share/icu/75.1/icudt75l.dat
```
...
u_setDataDirectory("PATH_TO_DIRECTORY_CONTAINING_icudt75l.dat");
...
# pod 'icu4c-iosx', :git => 'https://github.com/apotocki/icu4c-iosx', :tag => '75.1.4'
```    
