...
Repository branches generally correspond to ICU maintenance branches. For example, the `71` branch corresponds to the `maint/maint-71` branch in the ICU repository.

### Supported ICU Version: 71.1
...
git clone -b 71.1.6 https://github.com/apotocki/icu4c-iosx
...
# Data file path: product/share/icu/71.1/icudt71l.dat
```
...
u_setDataDirectory("PATH_TO_DIRECTORY_CONTAINING_icudt71l.dat");
...
# pod 'icu4c-iosx', :git => 'https://github.com/apotocki/icu4c-iosx', :tag => '71.1.6'
```    
