...
git clone -b 74.2.9 https://github.com/apotocki/icu4c-iosx
...
# Data file path: product/share/icu/74.2/icudt74l.dat
```
...
# pod 'icu4c-iosx', :git => 'https://github.com/apotocki/icu4c-iosx', :tag => '74.2.9'
```    
