...
Repository branches generally correspond to ICU maintenance branches. For example, the `62` branch corresponds to the `maint/maint-62` branch in the ICU repository.

### Supported ICU Version: 62.2
...
# Data file path: product/share/icu/62.2/icudt62l.dat
```
...
u_setDataDirectory("PATH_TO_DIRECTORY_CONTAINING_icudt62l.dat");
