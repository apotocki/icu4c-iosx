...
Repository branches generally correspond to ICU maintenance branches. For example, the `73` branch corresponds to the `maint/maint-73` branch in the ICU repository.

### Supported ICU Version: 73.2
...
git clone -b 73.2.2 https://github.com/apotocki/icu4c-iosx
...
# Data file path: product/share/icu/73.2/icudt73l.dat
```
...
u_setDataDirectory("PATH_TO_DIRECTORY_CONTAINING_icudt73l.dat");
...
# pod 'icu4c-iosx', :git => 'https://github.com/apotocki/icu4c-iosx', :tag => '73.2.2'
```    
