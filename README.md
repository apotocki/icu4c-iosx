...
Repository branches generally correspond to ICU maintenance branches. For example, the `76` branch corresponds to the `maint/maint-76` branch in the ICU repository.

### Supported ICU Version: 76.1
...
git clone -b 76.1.5 https://github.com/apotocki/icu4c-iosx
...
# Data file path: product/share/icu/76.1/icudt76l.dat
```
...
u_setDataDirectory("PATH_TO_DIRECTORY_CONTAINING_icudt76l.dat");
...
# pod 'icu4c-iosx', :git => 'https://github.com/apotocki/icu4c-iosx', :tag => '76.1.5'
```    
