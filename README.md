...
```
    # clone the repo
    git clone -b 72.1.1 --recursive https://github.com/apotocki/icu4c-iosx
...
```
    ...
    # pod 'icu4c-iosx', :git => 'https://github.com/apotocki/icu4c-iosx', :tag => '72.1.1', :submodules => 'true'
```    
