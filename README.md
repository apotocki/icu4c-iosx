...
Repository branches generally correspond to ICU maintenance branches. For example, the `77` branch corresponds to the `maint/maint-77` branch in the ICU repository.

### Supported ICU Version: 77.1
...
git clone -b 77.1.1 https://github.com/apotocki/icu4c-iosx
...
# Data file path: product/share/icu/77.1/icudt77l.dat
```
...
u_setDataDirectory("PATH_TO_DIRECTORY_CONTAINING_icudt77l.dat");
...
```ruby
use_frameworks!
pod 'icu4c-iosx', '~> 77.1.1'

# Or explicitly reference the repository
# pod 'icu4c-iosx', :git => 'https://github.com/apotocki/icu4c-iosx', :tag => '77.1.1'
```    
