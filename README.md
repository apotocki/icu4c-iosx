...
Repository branches generally correspond to ICU maintenance branches. For example, the `69` branch corresponds to the `maint/maint-69` branch in the ICU repository.

### Supported ICU Version: 69.1
...
git clone -b 69.1.3 https://github.com/apotocki/icu4c-iosx
...
# Data file path: product/share/icu/69.1/icudt69l.dat
```
...
u_setDataDirectory("PATH_TO_DIRECTORY_CONTAINING_icudt69l.dat");
...
# pod 'icu4c-iosx', :git => 'https://github.com/apotocki/icu4c-iosx', :tag => '69.1.3'
```    
